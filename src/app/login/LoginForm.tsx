...
export function LoginForm({ next }: { next?: string }) {
  ...
  return (
    ...
    >
      ...
      <div
        className="bc-meta"
        style={{ color: "var(--bc-text-ter)", marginTop: 6 }}
      >
        By {mode === "signin" ? "signing in" : "creating an account"} you agree
        to use BiteCheck as guidance, not medical advice. Always confirm with
        dining staff for medical-level needs.
      </div>
    </form>
  );
}
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          We audit dining labels against ingredient lists, allergen fields, and
          cross-contamination warnings — so you don&apos;t have to.
        </p>
      </div>
      <div
        aria-hidden
