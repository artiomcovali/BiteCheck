...
export function EmptyChat({
  ...
  return (
    ...
    >
      ...
      <p className="bc-body" style={{ color: 'var(--bc-text-sec)', marginBottom: 20 }}>
        I&apos;ll cross-check Cal Poly&apos;s dining data against your profile and flag anything
        uncertain before you eat it.
      </p>
